...
const projects = [
  {
    ...
    description:
      'A GenAI-powered career assistant built using OpenAI API and LangChain that provides interview preparation, mock Q&A, and personalized learning paths while fetching real-time job listings via RapidAPI with contextual RAG-based responses.',
    impact: 'Designed a modular backend supporting 50+ concurrent users and improved user engagement by 45% during prototype testing',
  ...
  },
  {
    ...
    description:
      'An automated EDA system that generates complete analytical reports and OpenAI-powered natural-language insights within seconds for any uploaded dataset.',
    impact: 'Reduced manual exploratory analysis effort by 80% and generated reports in under 15 seconds per dataset',
  ...
  {
    title: 'Violence Detection using InceptionV3 + LSTM',
    ...
    description:
      'A hybrid deep learning model combining InceptionV3 and LSTM for real-time violence detection that leverages motion-sequence integration to capture temporal patterns in video.',
    impact: 'Achieved 92% accuracy with strong precision (0.88) and recall (0.90) on the RWF-2000 dataset',
